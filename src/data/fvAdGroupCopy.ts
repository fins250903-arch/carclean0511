...
export const FV_AD_GROUP_COPY: FvAdGroupCopyDef[] = [
  {
    ...
    subCopy: [
      ...
      '博多・北九州・筑豊まで出張。20ｍ以内での家庭用１００Vコンセントをお借りします。',
  ...
  },
  {
    ...
    subCopy: [
      ...
      '那覇・浦添・宜野湾まで出張。20ｍ以内での家庭用１００Vコンセントをお借りします。',
      '沖縄本島の車内清掃　まとめて対応します。',
    ],
...
export const REGIONAL_FV_MAIN_TITLES: Record<string, string> = {
  ...
  大阪府: '大阪の車内クリーニング｜出張即日・プロ洗浄',
  兵庫県: '兵庫の車内清掃｜神戸・阪神へ即日出張',
  ...
  宮城県: '宮城の車内クリーニング｜仙台へ即日出張',
  茨城県: '茨城の車内クリーニング｜水戸・つくばへ最短即日出張',
  三重県: '三重の車内クリーニング｜四日市・津へ最短即日出張',
  岐阜県: '岐阜の車内クリーニング｜岐阜市・大垣へ最短即日出張',
  京都府: '京都の車内クリーニング｜京都市へ最短即日出張・プロ洗浄',
  滋賀県: '滋賀の車内クリーニング｜大津・草津へ最短即日出張',
  福井県: '福井の車内クリーニング｜福井市・敦賀へ最短即日出張',
  熊本県: '熊本の車内クリーニング｜熊本市へ最短即日出張',
  和歌山県: '和歌山の車内クリーニング｜和歌山市へ最短即日出張',
};
