...
export const regionalPosts: Record<string, RegionalPost> = {
    ...
    "宮城県": {
        ...
        `,
        image: getImage(4),
        aiSummary: `宮城県全域に対応する車内クリーニング・消臭洗浄の出張専門店です。仙台市・名取市・石巻市・多賀城市など県内各所へ最短即日で伺い、東北自動車道の渋滞中トラブルや松島・蔵王ドライブ帰りの「急な嘔吐」、東北の厳しい冬に多い「灯油こぼし」、融雪剤の泥汚れや通勤で蓄積した「汗・皮脂汚れ」まで業務用リンサーで根こそぎ洗浄。宮城県内に契約の出張枠があり、杜の都の地元密着スピード対応をお約束します。`,
        specs: [
            { label: "主な対応エリア", value: "仙台市、名取市、石巻市、富谷市、多賀城市、岩沼市、大崎市、気仙沼市ほか宮城県全域" },
    ...
    "福井県": {
        ...
        structuredData: {
            ...
            "image": "https://carinteriorcleaning.jp/images/fv-passenger-hero.png",
            "@id": "https://carinteriorcleaning.jp/regions/fukui/",
            "url": "https://carinteriorcleaning.jp/regions/fukui/",
            "telephone": "070-8428-0866",
            "address": {
                "@type": "PostalAddress",
                "addressRegion": "Fukui",
    ...
    "三重県": {
        title: "[三重県四日市市] 冬の灯油こぼし緊急洗浄事例",
        excerpt: "四日市市内にて、ポリタンク転倒による灯油こぼしの緊急依頼に対応。シート内部まで浸透した油分をリンサー抽出で除去しました。",
        content: `
            <h3 class="font-bold text-xl mb-4">冬の灯油こぼし緊急洗浄事例</h3>
            <p class="mb-4">四日市市内にて、ポリタンク転倒による灯油こぼしの緊急依頼。2日放置後の強烈な臭いで乗れない状態でしたが、業務用リンサーと中和洗浄で「乗れる状態」まで改善しました。</p>
            <div class="bg-blue-50 p-4 rounded-lg mt-6 border border-blue-200">
                <p class="font-bold text-blue-800">施工完了</p>
                <p class="text-sm mt-2">作業時間：3時間 / 灯油専用洗浄。1週間後のフォロー連絡も実施。</p>
            </div>
        `,
        image: getImage(1),
        aiSummary: `三重県全域に対応する車内クリーニング・消臭洗浄の出張専門店です。四日市・津・伊勢・鈴鹿など県内各所へ最短即日で伺い、冬場の「灯油こぼし」や「急な嘔吐」「ペット臭」を業務用リンサーで根こそぎ抽出洗浄。伊勢志摩ドライブ中の車酔いなど、三重ならではの緊急トラブルにも迅速に対応します。`,
        specs: [
    ...
    "岐阜県": {
        title: "[岐阜県岐阜市] お子様の嘔吐汚れ即日洗浄事例",
        excerpt: "岐阜市にて、高速道路の渋滞中にお子様が嘔吐。翌日の送迎に間に合うよう即日対応しました。",
        content: `
            <h3 class="font-bold text-xl mb-4">お子様の嘔吐汚れ即日洗浄事例</h3>
            <p class="mb-4">岐阜市にて、高速道路の渋滞中にお子様が突然嘔吐。翌日の送迎に間に合わせたいとのご依頼で、約40℃温水リンサーと100℃スチームによりシート奥の吐瀉物を抽出。作業後は無臭状態に復元しました。</p>
            <div class="bg-blue-50 p-4 rounded-lg mt-6 border border-blue-200">
                <p class="font-bold text-blue-800">施工完了</p>
        ...
        `,
        image: getImage(2),
        aiSummary: `岐阜県全域に対応する車内クリーニング・消臭洗浄の出張専門店です。岐阜市・大垣・多治見・高山など県内各所へ最短即日で伺い、「急な嘔吐」や「灯油こぼし」「ペットの粗相」を業務用リンサーで根こそぎ抽出洗浄。長距離ドライブ中の車酔いや冬場の灯油トラブルにも迅速に対応します。`,
        specs: [
